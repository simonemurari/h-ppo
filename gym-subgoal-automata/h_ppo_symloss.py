...
if __name__ == "__main__":
    ...
    if args.save_model:
        os.makedirs(f"models/h_ppo_symloss_{args.task}{args.run_code}", exist_ok=True)
        model_path = f"models/h_ppo_symloss_{args.task}{args.run_code}/h_ppo_symloss_seed={args.seed}.pt"
