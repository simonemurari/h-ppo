...
class Args:
    ...
    """stopping threshold for the rollout-level PSM fixed-point solver (paper J.1 uses 1e-7)"""

    p_2key: float = 0.0
    """probability of using n_keys=2 at each episode reset (0.0 = always 1 key, pure training)"""
