...
# ###############################################################################
# # ppo_RM evals (all maps, all eval types)
# ###############################################################################

# # --- 8x8 - 2 KEYS (ppo_RM) ---
# uv run aggregate_eval.py --master_seeds "${master_seeds[@]}" --n_keys 2 --size_env 8 --model_name "ppo_RM" --eval_type "standard" --no-track
# uv run aggregate_eval.py --master_seeds "${master_seeds[@]}" --n_keys 2 --size_env 8 --model_name "ppo_RM" --eval_type "random_rules" --no-track
# uv run aggregate_eval.py --master_seeds "${master_seeds[@]}" --n_keys 2 --size_env 8 --model_name "ppo_RM" --eval_type "h_ppo" --epsilon 1.0 --no-track
# uv run aggregate_eval.py --master_seeds "${master_seeds[@]}" --n_keys 2 --size_env 8 --model_name "ppo_RM" --eval_type "h_ppo" --epsilon 0.5 --no-track
# uv run aggregate_eval.py --master_seeds "${master_seeds[@]}" --n_keys 2 --size_env 8 --model_name "ppo_RM" --eval_type "h_ppo" --epsilon 0.25 --no-track

# # --- 8x8 - 4 KEYS (ppo_RM) ---
# uv run aggregate_eval.py --master_seeds "${master_seeds[@]}" --n_keys 4 --size_env 8 --model_name "ppo_RM" --eval_type "standard" --no-track
# uv run aggregate_eval.py --master_seeds "${master_seeds[@]}" --n_keys 4 --size_env 8 --model_name "ppo_RM" --eval_type "random_rules" --no-track
# uv run aggregate_eval.py --master_seeds "${master_seeds[@]}" --n_keys 4 --size_env 8 --model_name "ppo_RM" --eval_type "h_ppo" --epsilon 1.0 --no-track
# uv run aggregate_eval.py --master_seeds "${master_seeds[@]}" --n_keys 4 --size_env 8 --model_name "ppo_RM" --eval_type "h_ppo" --epsilon 0.5 --no-track
# uv run aggregate_eval.py --master_seeds "${master_seeds[@]}" --n_keys 4 --size_env 8 --model_name "ppo_RM" --eval_type "h_ppo" --epsilon 0.25 --no-track

# # --- 16x16 - 1 KEY (ppo_RM) ---
# uv run aggregate_eval.py --master_seeds "${master_seeds[@]}" --n_keys 1 --size_env 16 --model_name "ppo_RM" --eval_type "standard" --no-track
# uv run aggregate_eval.py --master_seeds "${master_seeds[@]}" --n_keys 1 --size_env 16 --model_name "ppo_RM" --eval_type "random_rules" --no-track
# uv run aggregate_eval.py --master_seeds "${master_seeds[@]}" --n_keys 1 --size_env 16 --model_name "ppo_RM" --eval_type "h_ppo" --epsilon 1.0 --no-track
# uv run aggregate_eval.py --master_seeds "${master_seeds[@]}" --n_keys 1 --size_env 16 --model_name "ppo_RM" --eval_type "h_ppo" --epsilon 0.5 --no-track
# uv run aggregate_eval.py --master_seeds "${master_seeds[@]}" --n_keys 1 --size_env 16 --model_name "ppo_RM" --eval_type "h_ppo" --epsilon 0.25 --no-track

# # --- 16x16 - 2 KEYS (ppo_RM) ---
# uv run aggregate_eval.py --master_seeds "${master_seeds[@]}" --n_keys 2 --size_env 16 --model_name "ppo_RM" --eval_type "standard" --no-track

python aggregate_eval.py --master_seeds "${master_seeds[@]}" --n_keys 2 --size_env 16 --model_name "ppo_RM" --eval_type "random_rules" --no-track
python aggregate_eval.py --master_seeds "${master_seeds[@]}" --n_keys 2 --size_env 16 --model_name "ppo_RM" --eval_type "h_ppo" --epsilon 1.0 --no-track
python aggregate_eval.py --master_seeds "${master_seeds[@]}" --n_keys 2 --size_env 16 --model_name "ppo_RM" --eval_type "h_ppo" --epsilon 0.5 --no-track
python aggregate_eval.py --master_seeds "${master_seeds[@]}" --n_keys 2 --size_env 16 --model_name "ppo_RM" --eval_type "h_ppo" --epsilon 0.25 --no-track

# --- 16x16 - 4 KEYS (ppo_RM) ---
python aggregate_eval.py --master_seeds "${master_seeds[@]}" --n_keys 4 --size_env 16 --model_name "ppo_RM" --eval_type "standard" --no-track
python aggregate_eval.py --master_seeds "${master_seeds[@]}" --n_keys 4 --size_env 16 --model_name "ppo_RM" --eval_type "random_rules" --no-track
python aggregate_eval.py --master_seeds "${master_seeds[@]}" --n_keys 4 --size_env 16 --model_name "ppo_RM" --eval_type "h_ppo" --epsilon 1.0 --no-track
python aggregate_eval.py --master_seeds "${master_seeds[@]}" --n_keys 4 --size_env 16 --model_name "ppo_RM" --eval_type "h_ppo" --epsilon 0.5 --no-track
python aggregate_eval.py --master_seeds "${master_seeds[@]}" --n_keys 4 --size_env 16 --model_name "ppo_RM" --eval_type "h_ppo" --epsilon 0.25 --no-track
