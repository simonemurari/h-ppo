...
if __name__ == "__main__":
    ...
    if args.save_model:
        os.makedirs(f"models/h_ppo_symloss_theta_{args.size_env}x{args.size_env}_{args.n_keys}keys{args.run_code}", exist_ok=True)
        model_path = f"models/h_ppo_symloss_theta_{args.size_env}x{args.size_env}_{args.n_keys}keys{args.run_code}/h_ppo_symloss_theta_seed={args.seed}.pt"
        ...
        try:
            ...
            episodic_returns = evaluate(
                ...
                seed=args.seed,
                group_name=f"h_ppo_symloss_theta_{args.group_name}_evals",
                Model=Agent,
                device=device,
                track=False,
                from_config=False,
